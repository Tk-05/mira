...
public final class DependencyCache {
    ...
    private static String sanitize(String url) {
        ...
        // Strip any leading slashes left behind (e.g. "file:///C:/foo" -> "/C:/foo" ->
        // "C:/foo"):
        // a leading slash makes java.nio.file.Path treat it as rooted on the current
        // drive on
        // Windows, which silently discards the ~/.mira/packages prefix when resolved
        // against it.
