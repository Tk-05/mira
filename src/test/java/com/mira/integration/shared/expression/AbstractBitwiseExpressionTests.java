...
public abstract class AbstractBitwiseExpressionTests {
    ...
    @Test
    void bitwiseAnd() {
        assertEquals("1", runForOutput("print(eval(3 & 1));"));
    }

    @Test
    void bitwiseOr() {
        assertEquals("7", runForOutput("print(eval(5 | 3));"));
    }

    @Test
    void bitwiseXor() {
        assertEquals("6", runForOutput("print(eval(5 ^ 3));"));
    }

    @Test
    void shiftLeft() {
        assertEquals("8", runForOutput("print(eval(1 << 3));"));
    }

    @Test
    void shiftRight() {
        assertEquals("2", runForOutput("print(eval(8 >> 2));"));
    }
